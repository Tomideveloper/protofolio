...
<head>
  ...
  <link rel="stylesheet" href="{{url('public/frontendassests/style.css')}}" />
  <!-- box icons -->
  <link
...
<body>
    ...
    <div class="book">
      ...
      <div class="book-page page-left">
        <div class="profile-page">
          <img src="{{url('public/profilepic/',$profiles->image)}}" alt="" />
          <h1>{{$profiles->name}}</h1>
          <h3>{{$profiles->profession}} </h3>
          <div class="social-media">
            <a href="{{$profiles->fb_link}}"><i class="bx bxl-facebook"></i></a>
            <a href="{{$profiles->tk_link}}"><i class="bx bxl-twitter"></i></a>
            <a href="{{$profiles->linkedin_link}}"><i class="bx bxl-linkedin"></i></a>
            <a href="{{$profiles->insta_link}}"><i class="bx bxl-instagram-alt"></i></a>
          </div>
          <p>
      ...
      <div class="book-page page-right turn" id="turn-1">
        ...
        <div class="page-front">
          ...
          <div class="workeduc-box">
            ...
            <div class="workeduc-content">
              <span class="year"><i class="bx bx-calendar"></i>{{$work->date}}</span>
        ...
        <div class="page-back">
          ...
          <div class="workeduc-box">
            ...
            <div class="workeduc-content">
              <span class="year"><i class="bx bx-calendar"></i>{{$edu->time}}</span>
              <h3>{{$edu->title}}</h3>
              <p>
                {{$edu->description}}
              </p>
  ...
  <script src="{{url('public/frontendassests/script.js')}}"></script>
</body>
